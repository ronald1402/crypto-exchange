...
import { appTitle, chains, useWallet, useContract } from '@openware/opendax-web-sdk'
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {abi.map((item) => (
                                                <tr
                                                    ...
                                                    className="bg-white"
                                                >
                                                    <td className="px-6 py-4 whitespace-nowrap text-ellipsis text-sm text-gray-900">
                                                        <div className="flex">
                                                    ...
                                                    <td className="hidden px-6 py-4 whitespace-nowrap text-ellipsis text-sm text-gray-500 lg:block">
                                                    ...
                                                    <td className="max-w-0 w-full px-6 py-4 text-right whitespace-nowrap text-ellipsis text-sm text-gray-500">
